...
const PokedexScreen: React.FC<PokedexScreenProps> = ({ data, loading, onPlayAudio, hasAudio }) => {
  ...
  const chartData = [
    { subject: 'HP', A: data.stats.hp, fullMark: 255 },
    { subject: 'ATK', A: data.stats.attack, fullMark: 255 },
    { subject: 'DEF', A: data.stats.defense, fullMark: 255 },
    { subject: 'SPD', A: data.stats.speed, fullMark: 255 },
    { subject: 'S.DEF', A: data.stats.spDef, fullMark: 255 },
    { subject: 'S.ATK', A: data.stats.spAtk, fullMark: 255 },
  ];
    ...
    <div className="w-full h-full bg-[#98CB98] border-8 border-gray-700 rounded-lg p-2 shadow-[inset_0_0_20px_rgba(0,0,0,0.1)] font-mono relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-20 text-gray-900 h-full overflow-y-auto pb-4 custom-scrollbar">
        ...
        <div className="border-b-2 border-gray-800 pb-1 mb-2 flex justify-between items-end">
          <h2 className="text-xl font-bold truncate">{data.speciesName}</h2>
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          <div className="col-span-1">
             <StatRow label="HP" value={data.stats.hp} />
             <StatRow label="攻" value={data.stats.attack} />
             <StatRow label="防" value={data.stats.defense} />
             <StatRow label="特攻" value={data.stats.spAtk} />
             <StatRow label="特防" value={data.stats.spDef} />
             <StatRow label="素早" value={data.stats.speed} />
          </div>
